...
public class TestDataInitializer {
    ...
    public void init() throws Exception {
        ...
        session.persist(new Drive(user, "A drive to Dpils", "Riga", "Daugavpils", "Brivibas 20", "Skolas iela 25",
                new Date(System.currentTimeMillis()), new Date(System.currentTimeMillis()+1000*60*60*3), "I go Dpils", 20.,
                "BA-8283", 3, 4));
        session.persist(new Drive(user, "A drive to Liepaja", "Riga", "Liepaja", "Kalku 10", "Rigas iela 25",
                new Date(System.currentTimeMillis()), new Date(System.currentTimeMillis()+1000*60*60*3), "I go Liepaja", 10.,
                "EH-1409", 3, 4));
        session.persist(new Drive(user, "A drive to Ventspils", "Riga", "Ventspils", "Centrala stacija", "Raina iela 15",
